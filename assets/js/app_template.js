...
App.config(['$stateProvider', '$urlRouterProvider',
    function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            .state('angularjs', {
                url: '/angularjs',
                templateUrl: 'assets/views1/ready_angularjs.html'
            })
            .state('dashboard', {
                url: '/dashboard',
                templateUrl: 'assets/views1/ready_dashboard.html',
            ...
            .state('uiActivity', {
                url: '/ui/activity',
                templateUrl: 'assets/views1/ui_activity.html',
            ...
            .state('uiTabs', {
                url: '/ui/tabs',
                templateUrl: 'assets/views1/ui_tabs.html'
            })
            .state('uiModalsTooltips', {
                url: '/ui/modals-tooltips',
                templateUrl: 'assets/views1/ui_modals_tooltips.html'
            })
            .state('uiColorThemes', {
                url: '/ui/color-themes',
                templateUrl: 'assets/views1/ui_color_themes.html'
            })
            .state('uiBlocksDraggable', {
                url: '/ui/blocks-draggable',
                templateUrl: 'assets/views1/ui_blocks_draggable.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('uiChatFull', {
                url: '/ui/chat/full',
                templateUrl: 'assets/views1/ui_chat_full.html',
                controller: 'UiChatCtrl'
            })
            .state('uiChatFixed', {
                url: '/ui/chat/fixed',
                templateUrl: 'assets/views1/ui_chat_fixed.html',
                controller: 'UiChatCtrl'
            })
            .state('uiChatPopup', {
                url: '/ui/chat/popup',
                templateUrl: 'assets/views1/ui_chat_popup.html',
                controller: 'UiChatCtrl'
            })
            .state('tablesTools', {
                url: '/tables/tools',
                templateUrl: 'assets/views1/tables_tools.html'
            })
            .state('tablesDatatables', {
                url: '/tables/datatables',
                templateUrl: 'assets/views1/tables_datatables.html',
            ...
            .state('formsPickersMore', {
                ...
                templateUrl: 'assets/views1/forms_pickers_more.html',
            ...
            .state('formsEditors', {
                url: '/forms/editors',
                templateUrl: 'assets/views1/forms_editors.html',
            ...
            .state('formsValidation', {
                ...
                templateUrl: 'assets/views1/forms_validation.html',
            ...
            .state('formsWizard', {
                url: '/forms/wizard',
                templateUrl: 'assets/views1/forms_wizard.html',
            ...
            .state('compCharts', {
                ...
                templateUrl: 'assets/views1/comp_charts.html',
            ...
            .state('compCalendar', {
                ...
                templateUrl: 'assets/views1/comp_calendar.html',
            ...
            .state('compSliders', {
                ...
                templateUrl: 'assets/views1/comp_sliders.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('compScrolling', {
                ...
                templateUrl: 'assets/views1/comp_scrolling.html'
            })
            .state('compSyntaxHighlighting', {
                url: '/components/syntax-highlighting',
                templateUrl: 'assets/views1/comp_syntax_highlighting.html',
            ...
            .state('compRating', {
                ...
                templateUrl: 'assets/views1/comp_rating.html',
            ...
            .state('compTreeview', {
                ...
                templateUrl: 'assets/views1/comp_treeview.html',
            ...
            .state('compMapsGoogle', {
                ...
                templateUrl: 'assets/views1/comp_maps.html',
            ...
            .state('compMapsGoogleFull', {
                ...
                templateUrl: 'assets/views1/comp_maps_full.html',
            ...
            .state('compMapsVector', {
                ...
                templateUrl: 'assets/views1/comp_maps_vector.html',
            ...
            .state('compGallerySimple', {
                ...
                templateUrl: 'assets/views1/comp_gallery_simple.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('compGalleryAdvanced', {
                ...
                templateUrl: 'assets/views1/comp_gallery_advanced.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('blocks', {
                url: '/blocks',
                templateUrl: 'assets/views1/api_blocks.html'
            })
            .state('layout', {
                url: '/layout',
                templateUrl: 'assets/views1/api_layout.html'
            })
            .state('create', {
                url: '/create',
                templateUrl: 'assets/views1/ready_create.html'
            });
    }
]);
